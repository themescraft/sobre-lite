 ...
 */
function sobre_lite_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function sobre_lite_sanitize_css( $css ) {
 ...
 */
function sobre_lite_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function sobre_lite_sanitize_email( $email, $setting ) {
 ...
 */
function sobre_lite_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function sobre_lite_sanitize_html( $html ) {
 ...
 */
function sobre_lite_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function sobre_lite_sanitize_nohtml( $nohtml ) {
 ...
 */
function sobre_lite_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function sobre_lite_sanitize_number_range( $number, $setting ) {
 ...
 */
function sobre_lite_sanitize_select( $input, $setting ) {
 ...
 */
function sobre_lite_sanitize_url( $url ) {
